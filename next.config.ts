...
const nextConfig: NextConfig = {
  ...
  // font files out of the bundle, so every PDF export crashed with
  // MODULE_NOT_FOUND. Keeping these modules external deploys their full
  // node_modules tree (fonts included) and the includes below force the font
  // directory into the traced function output.
